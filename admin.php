<?php
// admin.php - SENTINEL UI SHELL
$ADMIN_PW = "admin123"; // MUST MATCH api.php
if (($_GET['pw'] ?? '') !== $ADMIN_PW) {
    die("ACCESS DENIED");
}
?>
            ...
            <div class="flex-1 overflow-auto">
                <table class="w-full text-left border-collapse whitespace-nowrap">
                    ...
                    <tbody class="text-xs font-mono">
                        ...
                        <tr v-for="log in logs" :key="log.id" @click="openDeepScan(log)" class="border-b border-white/5 hover:bg-cyan-500/10 transition cursor-pointer group">
                            <td class="p-3 text-gray-400">{{ log.timestamp }}</td>
        ...
        <div v-if="selectedLog" class="modal-overlay" @click.self="selectedLog = null">
            <div class="cyber-border modal-content p-6 shadow-2xl">
                ...
                <div class="grid grid-cols-2 gap-4 text-sm font-mono mb-6">
                    ...
                    <div><span class="text-gray-500 block text-[10px]">TIMESTAMP</span><span class="text-gray-200">{{ selectedLog.timestamp }}</span></div>
